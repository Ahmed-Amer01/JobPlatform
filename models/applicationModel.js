...
const applicationSchema = new mongoose.Schema(
  {
    ...
    coverLetter: {
      ...
      validate: {
        ...
        message: "Please provide a valid resume file", // Validate for resume file types
      },
      ...
      coverLetterFileSize: {
        ...
        validate: {
          validator: function (v) {
            return v <= 5 * 1024 * 1024;
          },
          message: "Cover letter must not exceed 5MB",
        },
      },
    },
    status: {
